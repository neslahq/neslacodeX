...
class Parallelism:
    ...
    """
    The order of the parallelism to apply.
    The order is a list of strings, each string is the name of the parallelism to apply.
    The order is applied in the order of the list.
    The supported parallelism are: "dp_replicate", "pp", "tp", "cp", "ep", "etp".
    """
